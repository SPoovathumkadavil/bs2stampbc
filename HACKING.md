...
hidden if the `stampbc_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `stampbc_DEVELOPER_MODE` to the configure
...
Runs the executable target `stampbc_exe`.
